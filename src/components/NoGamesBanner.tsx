...
import { Button, Title, Subheading, Colors, Divider } from 'react-native-paper'
...
function NoGamesBanner({ navigation }: { navigation: NavigationStackProp }) {
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 }}>
            ...
            <Title style={{ marginTop: 20, color: Colors.grey800 }}>{getText('welcome')} !</Title>
            <Divider />

            <Subheading style={{ textAlign: 'center', color: Colors.grey600, padding: 10, width: 250 }}>
